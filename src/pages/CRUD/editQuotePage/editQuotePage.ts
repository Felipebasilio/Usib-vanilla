import { api_url, editData } from "./../../../API_Connection/API_Connection";
    ...
    window.addEventListener("DOMContentLoaded", (e) => {    
      ...
      formToFill.addEventListener("submit", (e) => {
        ...
        const formValues: DATAFROMDB = {
          ...
          if(ElementId) {
            editData(formValues, ElementId).then(() => {
...
export async function fillForm() {
    ...
    (document.querySelector("#product > option") as HTMLOptionElement).value = dataFromDb.Product;
